...
class MyForegroundService : Service() {
    ...
    private fun buildNotification(): Notification {
        ...
        val notificationBuilder = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentText("Saat ini foreground service sedang berjalan yah firdaus.")
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        ...
        serviceScope.launch {
            for (i in 1..50) {
                delay(1000)
                Log.d(TAG, "Do Something here Firdaus $i")
            }
            stopForeground(true);
            stopSelf()
            Log.d(TAG, "Service dihentikan yah firdaus")
        }
        return START_STICKY
    }
    ...
    override fun onDestroy() {
        super.onDestroy()
        serviceJob.cancel()
        Log.d(TAG, "onDestroy: Service dihentikan yah firdauss")
    }
}